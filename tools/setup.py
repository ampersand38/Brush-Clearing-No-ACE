...
def main():
    ...
    print("""
  ######################################
  # BCNA Development Environment Setup #
  ######################################

  This script will create your BCNA dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your BCNA project folder:
    [Arma 3 installation directory]\\{} => BCNA project folder
    P:\\{}                              => BCNA project folder
